...
// Auth information
global.pairNumber = "263773523006";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["918433897160", "918433897160"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["918433897160", "918433897160"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["918433897160"];
global.OwnerName = process.env.OWNER_NAME || "尺ㄖ爪乇Ҝ-乂ᗪ";
global.BotName = process.env.BOT_NAME || "尺ㄖ爪乇Ҝ-乂ᗪ ᐯ3";
